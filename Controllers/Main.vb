...
u.TName AS CSName, u.MobilePhone AS CSTel, u.EMail AS CSEMail, j.InvNo, j.InvProduct, j.InvProductQty, j.InvProductUnit, j.TotalContainer, 
a.English AS ForwarderName, a.EAddress1 AS ForwarderAddress1, a.EAddress2 AS ForwarderAddress2, a.ContactSale AS ForwarderContact, 
a.Phone AS ForwarderPhone, c.NameEng AS ConsigneeName, c.EAddress1 AS ConsignAddress1, c.EAddress2 AS ConsignAddress2, c.Phone AS ConsignPhone, 
n.NameEng AS NotifyName, n.EAddress1 AS NotifyAddress1, n.EAddress2 AS NotifyAddress2, n.Phone AS NotifyPhone, j.VesselName, j.MVesselName, 
...
h.ReturnTime, h.TransMode, h.PaymentCondition, h.PaymentBy, d.CTN_NO, d.SealNumber, d.TruckNO, d.Comment, d.TruckType, d.Driver, d.Location, 
...
d.UnloadDate AS TargetDeliveryDate, d.UnloadFinishDate AS ActualDeliveryDate, d.TruckIN AS TargetReturnDate, d.ReturnDate AS ActualReturnDate, j.JobType, 
j.ShipBy, j.AgentCode, s.NameEng AS ShipperName, s.EAddress1 AS ShipperAddress1, s.EAddress2 AS ShipperAddress2, s.Phone AS ShipperPhone, 
