...
<div style="text-align:right;width:98%;">
    <label style="font-size:16px;font-weight:bold;" id="lblTitleE">TAX INVOICE/OFFICIAL RECEIPT</label>
    <br />
    <label style="font-size:16px;font-weight:bold;" id="lblTitleT">ใบกำกับภาษี/ใบเสร็จรับเงิน</label>
</div>
<br />
...
<script type="text/javascript">
    ...
    function ShowData(dt) {
        ...
        if (h.ReceiptType == 'TAX') {
            $('#lblTitleE').text('TAX-INVOICE/OFFICIAL RECEIPT');
            $('#lblTitleT').text('ใบกำกับภาษี/ใบเสร็จรับเงิน');
	else if (h.ReceiptType == 'RCV') {
	    $('#lblTitleE').text('INTERNAL RECEIPT');
            $('#lblTitleT').text('ใบเสร็จภายใน');
        } else {
            $('#lblTitleE').text('OFFICIAL RECEIPT');
            $('#lblTitleT').text('ใบเสร็จรับเงิน');
        }
