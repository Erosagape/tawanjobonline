...
<div style="display:flex;flex-direction:column;align-items:center;width:100%;">
    <div class="div3">
        <div>
            ...
            P.O. no. &nbsp;<label style="display:inline-block;width:200px;text-decoration:underline" id="lblCustRefNo">________________________</label><br />
    ...
    if (docno !== '') {
        $.get(path + 'JobOrder/GetTransportReport?Branch=' + branch + '&Doc=' + docno, function (r) {
            if (r.transport.data.length > 0) {
                ...
                if (j.EstDeliverDate!==null>1) $('#lblDeliveryDate').text(ShowDate(j.UnloadDate));
                if (j.DeliveryNo!==null>1) $('#lblDeliveryNo').text(j.DeliveryNo);
                if (j.ContactName!==null>1) $('#lblDeliveryTo').text(j.PlaceName2);
                if (j.Location!==null>1) $('#lblDeliveryAddr').text(j.PlaceAddress2);
