...
$.get(path + 'JobOrder/GetBooking?Branch=' + br + '&Code=' + doc).done(function (r) {
        if (r.booking !== null) {
           ...
           // row.append($('<td>' + 'N.W ' + ShowNumber(h.TotalNW, 3) + ' ' + h.GWUnit + '</td>'));
            ...
            $('#dvDetail').append($('<tr style=""><td class="vbodered"></td><td class="vbodered"></td><td class="vbodered"></td><td class="vbodered"></td><td class="vbodered"></td></tr>'));
        }
    });
    }
</script>