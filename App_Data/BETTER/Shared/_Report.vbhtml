            ...
            <div style="display:flex" id="dvCompLogo">
                <div style="flex:1;vertical-align:middle">
                    @If ViewBag.DATABASE = "1" Then
                        @<img id="imgLogo" src="~/Resource/logo_dyy.jpg" style="width:50px" />
                    End If
                    @If ViewBag.DATABASE = "2" Then
                        @<img id="imgLogo" src="~/Resource/logo_dyy_t.jpeg" style="width:50px" />
                    End If
                    @If ViewBag.DATABASE = "3" Then
                        @<img id="imgLogo" src="~/Resource/logo_porchoen.png" style="width:50px" />
                    End If
                </div>
