...
<table id="taxtable" style="border-style:solid;width:100%; margin-top:5px" class="text-center">
    ...
    <tr>
        <td rowspan="4" colspan="3" style="border-right:1px black solid">
...
<script type="text/javascript">
    ...
    function ShowData(dt) {
        ...
        for (let d of dt) {
            ...
            html += '<td style="text-align:right">' + ShowNumber(h.FAmt / h.Qty, 2) + '</td>';
        ...
        let blankRow = '<tr><td><br></td><td></td><td></td><td></td><td></td></tr>'
        let blankRows = "";
