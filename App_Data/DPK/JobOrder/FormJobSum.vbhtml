...
<div style="display:flex">
    ...
    <div style="flex:1">
        SALES CODE : <label id="lblManagerCode"></label>
    </div>
</div>
<div style="display:flex">
    <div style="flex:2">
...
<table style="border-collapse:collapse;width:100%">
    <tr>
        <td style="width:25%;border-style:solid;border-width:thin;text-align:center;vertical-align:top">
            C/S
        </td>
        <td style="width:25%;border-style:solid;border-width:thin;text-align:center;vertical-align:top">
            ACCOUNT
    ...
    function GetJobInfo(branch, jno) {
        $.get(path+ 'joborder/getjobreport?branch=' + branch + '&jno=' + jno, function (r) {
            if (r.job.data.length > 0) {
                ...
                $('#lblManagerCode').text(h.ManagerCode);
            }
        });
    }
