    ...
    <table id="tbExpenses" style="width:100%;border-collapse:collapse;font-size:8px">
        ...
        <tbody>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าศุลกากรหน้าด่าน (ศบ)</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                <td style="border-style:solid;border-width:thin;">ค่าภาษีอากร / VAT</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าธรรมเนียมตลาด</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าธรรมเนียมตรวจคนเข้าเมือง (ตม)</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าเดินตัวศุลกากร</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าพาสปอร์ต</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าขนถ่ายสินค้า</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าแรงงานขนถ่ายสินค้า</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่ารถขนส่งสินค้า 4 ล้อ</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่ารถขนส่งสินค้า 6 ล้อ</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่ารถขนส่งสินค้า 10 ล้อ</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่ารถขนส่งสินค้า 18 ล้อพ่วง</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าใช้จ่ายเจ้าหน้าที่ปศุสัตว์</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
                <td style="border-style:solid;border-width:thin;">ค่า Form D</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าใช้จ่ายเจ้าหน้าที่สรรพสามิต</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>                
                <td style="border-style:solid;border-width:thin;">ค่า Form CO</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าเจ้าหน้าที่ตรวจพืช</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>                
                <td style="border-style:solid;border-width:thin;">ค่าใช้จ่ายอื่นๆ</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
                <td style="border-style:solid;border-width:thin;">ค่าส่งเอกสาร</td>
                <td style="border-style:solid;border-width:thin;">&nbsp;</td>
            </tr>
            <tr>
