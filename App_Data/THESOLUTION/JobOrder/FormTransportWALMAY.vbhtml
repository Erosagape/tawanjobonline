...
<table style="width:100%">
    <tr>
        <td style="display:flex">
            <img src="~/Resource/logo-walmay.jpg" style="width:150px;">
            <div>
                <b style="font-size:18px">WALMAY LOGISTICS INC.</b>
                <br /><span style="font-size:14px;">FMC BOND NUMBER 024108N</span>
            </div>
