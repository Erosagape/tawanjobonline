...
GO
INSERT [dbo].[TWTCustomer] ([CustID], [CustName], [CustTaxID], [CustAddress], [CustContact], [CustTelFaxMobile], [BeginDate], [ExpireDate], [Active], [CustRemark], [CustMessage]) VALUES (N'TAWAN', N'ตะวันเทคโนโลยี', N'-', N'-', N'-', N'-', CAST(N'1900-01-01 00:00:00.000' AS DateTime), CAST(N'9999-12-31 00:00:00.000' AS DateTime), 1, N'ระบบทดสอบ', N'สวัสดีครับ')
INSERT [dbo].[TWTCustomer] ([CustID], [CustName], [CustTaxID], [CustAddress], [CustContact], [CustTelFaxMobile], [BeginDate], [ExpireDate], [Active], [CustRemark], [CustMessage]) VALUES (N'KWAN', N'ขวัญชัย เทคโนโลยี แอนด์ คอนซัลแทนท์', N'-', N'-', N'-', N'-', CAST(N'1900-01-01 00:00:00.000' AS DateTime), CAST(N'9999-12-31 00:00:00.000' AS DateTime), 1, N'ระบบทดสอบ', N'สวัสดีครับ')
GO
...
INSERT [dbo].[TWTCustomerApp] ([AppID], [CustID], [WebURL], [WebDBType], [WebTranDB], [WebMasDB], [WebTranConnect], [WebMasConnect], [Active], [SubscriptionID], [Seq], [DefaultLang]) VALUES (N'JOBSHIPPING', N'TAWAN', N'trial.tawanasp.com', 0, N'job_trial', N'jobmaster', N'Data Source=.\MSSQLSERVER2016;Initial Catalog=job_trial;User id=jobtrial;Password=ucrC89I55y;Persist Security Info=False', N'Data Source=.\MSSQLSERVER2016;Initial Catalog=jobmaster;User id=tawanasp;Password=ucrC89I55y;Persist Security Info=False', 1, 1, 1, N'TH')
