            ...
            <div id="tab2" class="tab-pane fade">
                <div class="row">
                    ...
                    <div class="col-sm-3 table-bordered" id="dvChqCash">
                        <b id="linkChqCash">Transfer :</b><input type="text" id="txtAdvChqCash" class="form-control" value="" />
                        <br />
                        <table>
                            <tr>
                                <td>
        ...
        $.get(path + 'adv/getadvancegrid?branchcode=' + $('#txtBranchCode').val() + w, function (r) {
            ...
            let tb=$('#tbHeader').DataTable({
                ...
                columns: [ //กำหนด property ของ header column
                    ...
                    {
                        data: "AdvCashCal", title: "Cash",
                        render: function (data) {
                            return ShowNumber(data, 2);
                        }
                    },
                    {
                        data: "AdvChqCashCal", title: "Transfer",
                        render: function (data) {
                            return ShowNumber(data, 2);
                        }
                    },
