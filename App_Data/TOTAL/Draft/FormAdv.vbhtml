...
<table style="border-collapse:collapse;width:100%">
    ...
    <tr>
        ...
        <td></td>
        <td style="border-style: solid; border-width: thin; text-align: right; font-weight: bold;"  width="130px"><label style="color: red;font-size: 16px;">Customer Payment</label></td>
        <td style="border-style: solid; border-width: thin; font-size: 16px" width="150px">
            <input type="text" style="border: none; text-align: right; color: red; font-size: 16px; width: 100%; font-weight: bold;" id="txtCustomerPayment2" />
        </td>
    </tr>
</table>
    ...
    function ShowData(data) {
        ...
        $('#txtAmt').val(CCurrency((h.TotalAdvance + h.Total50Tavi - h.TotalVAT).toFixed(2)))
