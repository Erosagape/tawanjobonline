    ...
    <div class="w3-sidebar w3-bar-block w3-animate-left" style="display:none;z-index:5" id="mySidebar">
        <div class="w3-sidebar w3-bar-block w3-indigo w3-card" style="width:250px;">
            ...
            <div style="width:100%;text-align:center;background-color:white">
                <img id="imgMenu" src="~/Resource/logo-tawan.jpg" onclick="SetLogout()" style="width:30%;padding:5px 5px 5px 5px;" />
            </div>
                    ...
                    <div Class="panel-title">
                        <div class="row">
                            <div class="col-xs-5 col-md-2" style="text-align:center">
                                <img id="imgCompany" src="~/Resource/logo-tawan.jpg" style="width:50%;height:55px" onclick="w3_open();" />
                            </div>
