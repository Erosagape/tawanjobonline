...
<style>
    ...
    body {
        ...
        counter-reset: my-sec-counte;
    }
    tr {
        counter-increment: my-sec-counte;
    }
    thead tr #pageNo::before {
        /* Increment "my-sec-counter" by 1 */

        content: "Section " counter(my-sec-counte) ". ";
    }
...
<table>
    <thead style="border-color :green">
        <tr style="width:100%">
            <td id="pageNo" style="width:100%;text-align:right"></td>
        </tr>
        <tr style="border-color :yellow">
