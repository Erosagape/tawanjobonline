...
<img src="~/Resource/logo-walmay.jpg" style="float:left">
<div style="font-size:10px">
    <h1 style="float:right">BILL OF LADING</h1>
    <h2>WALMAY LOGISTICS INC.</h2>
    <br />FMC BOND NUMBER 024108N
</div>
<p>
    <table style="width:100%">
        <tr>
            <td class="top-left" style="height:100px;width:50%;" rowspan="2" colspan="2">
                SHIPPER/EXPORTER
            </td>
            <td class="top-left right" style="width:50%;" colspan="2">
                BILL OF LADING NO
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="top-left" style="width:50%;height:100px;" rowspan="2" colspan="2">
                CONSIGNEE
            </td>
            <td class="top-left right" style="width:50%;" colspan="2">
                FORWARDING AGENT
        ...
        <tr>
            <td class="top-left" style="width:50%;height:100px;" colspan="2">
                NOTIFY PARTY
            </td>
            <td class="top-left right" style="width:50%;" colspan="2" rowspan="2">
        ...
        <tr style="height:30px;">
            ...
            <td class="top-left right" style="width:25%;">
                PLACE OF RECEIPT
            </td>
        </tr>
        <tr style="height:30px;">
        ...
        <tr style="height:30px;">
            <td class="top-left bottom-right" style="width:25%;">
                PORT OF DISCHARGE
            </td>
            <td class="top-left bottom-right" style="width:25%;">
                PLACE OF DELIVERY
            ...
            <td class="top-left bottom-right" style="width:25%;">
                FINAL DESTINATION (FOR THE MERCHANT's REF)
            </td>
        </tr>
    </table>
    <table style="width:100%">
        <tr>
            <td class="bottom-left right" colspan="5" style="width:100%;text-align: center;">
        ...
        <tr>
            ...
            <td class="bottom-left right" style="text-align:center;">
                MEASUREMENT
            </td>
        </tr>
    ...
    <table style="width:100%">
        <tr>
            <td class="bottom-left" style="width:20%;text-align:center;">
                FREIGHT AND CHARGES REVENUE TONS RATE PER
            </td>
            <td class="bottom-left" style="width:13%;text-align:center;">
                PREPAID
            </td>
            <td class="bottom-left" style="width:12%;text-align:center;">
                COLLECT
            </td>
            <td class="bottom-left right" colspan="2" rowspan="2" style="width:55%">
        ...
        <tr>
            <td class="bottom-left" rowspan="4">
            </td>
            <td class="bottom-left" rowspan="4">
            </td>
            <td class="bottom-left" rowspan="4">
        ...
        <tr>
            <td class="bottom-left right" colspan="2">
        ...
        <tr>
            <td class="bottom-left" style="text-align:center;font-size:11px;font-weight:bold;">
                AS AGENT FOR THE CARRIER,
                <br />
            </td>
            <td class="bottom-right" style="text-align:right;">
                For The Company
            </td>
        </tr>
        <tr>
            <td class="bottom-left" rowspan="2">
                ATTENTION OF SHIPPER : The term and conditions of the order bill of lading under which this shipment is accepted are printed on the back hereof. Note unless otherwise specified the charges listed above do not include customs duties,taxes customs clearance
                charges and similar non transportation charges which are for the account of the cargo.
            </td>
            <td class="bottom-left right" rowspan="2" style="width:15%">
                B/L NO.
            </td>
        </tr>
        <tr style="height:30px;">
            <td class="bottom-left" style="font-size:12px;text-align:center;">
                <b>TOTAL</b>
            </td>
...
<p style="font-size:5px;">
    <b>Bill of Lading – Terms and Conditions</b>
    <br />
