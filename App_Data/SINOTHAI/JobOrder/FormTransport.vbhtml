...
<div style="align-content:center;width:100%;padding-left:10px;">
    <br /><br /><br />
    <div style="display:flex">
        ...
        <div style="flex-direction:row;width:58%;font-size:12px;border-top:solid;border-right:solid;border-left:solid;border-bottom:solid;border-width:thin;">
            <div style="display:flex;flex-direction:column;">
    ...
    <div style="width:98%;display:flex;flex-direction:row;font-size:10px;border-right:solid;border-left:solid;border-bottom:solid;border-width:thin;">
        <div style="flex:1;">
    ...
    <div style="width:98%;display:flex;flex-direction:row;font-size:10px;text-align:center;border-right:solid;border-left:solid;border-bottom:solid;border-width:thin;">
    ...
    <div id="dvDetail" style="width:98%;height:400px;vertical-align:top;display:flex;flex-direction:column;font-size:10px;border-right:solid;border-left:solid;border-bottom:solid;border-width:thin;">
    </div>
    <div style="width:98%;display:flex;flex-direction:row;font-size:10px;text-align:center;border-right:solid;border-left:solid;border-bottom:solid;border-width:thin;">
    ...
    <div style="display:flex;">
        ...
        <div style="width:58%;font-size:10px;border-left:solid;border-right:solid;border-bottom:solid;border-width:thin;">
            <div>
                <b>Type of Service</b>
