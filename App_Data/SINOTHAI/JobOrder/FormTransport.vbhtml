...
<div style="font-size:11px;border-style:solid;border-width:thin;">
            <div style="display:flex;flex-direction:row">
                <div style="flex:3;border-style:solid;border-width:thin;border-collapse:collapse">
                ...
                <div style="flex:4;border-style:solid;border-width:thin;border-collapse:collapse">
   ...
   $('#lblProductUnit').text(h.InvProductUnit);
	...
	if(confirm("Print PO/Commercial Invoice?")==true) {
	 Showinv=true;
            ...
            let html = '';
            html += '<div style="width:100%;text-align:center;font-size:9px">"SHIPPER LOAD & COUNT & SEAL"<br/>"SAID TO CONTAIN ('+ h.TransMode +')"</div>';
	...
	if(Showinv==true) {
            ...
            for (i = 0; i < r.booking.data.length; i++){
                let htmlTemplate = '<div style="width:100%;display:flex;flex-direction:row;font-size:9px">';
