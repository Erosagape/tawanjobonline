        ...
        Using cn As New SqlConnection(m_ConnStr)
            Try
                ...
                Using cm As New SqlCommand
                    cm.Connection = cn
                    cm.CommandTimeout = Convert.ToInt32(GetValueConfig("PROFILE", "QUERY_TIMEOUT", 600))
                    cm.CommandText = pSQL
        ...
        Using cn As New SqlConnection(m_ConnStr)
            Try
                ...
                Using da As New SqlDataAdapter(pSQL, cn)
                    da.SelectCommand.CommandTimeout = Convert.ToInt32(GetValueConfig("PROFILE", "QUERY_TIMEOUT", 600))
                    da.Fill(dt)
                End Using
