...
<div class="panel-body">
    <div class="container">
        ...
        <div id="dvCommand">
            ...
            <a href="#" class="btn btn-primary" id="btnPrint" onclick="PrintSOA()">
                <i class="fa fa-lg fa-print"></i>&nbsp;<b id="linkPrint">Print SOA</b>
            </a>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function PrintSOA() {
        ...
        window.open(path + 'Acc/FormVoucher?branch=' + $('#txtBranchCode').val() + '&controlno=' + $('#txtControlNo').val() + '&form=DC');
    }
