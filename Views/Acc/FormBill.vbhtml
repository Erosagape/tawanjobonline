    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border-left:1px solid #66FFCC" rowspan="3" colspan="3">
                ...
                <p style="text-align:center;font-weight:bold;font-size:16px">ใบแจ้งยอดบัญชี <br />(STATEMENT OF ACCOUNTS) </p>
            </td>
        </tr>
        <tr>
        </tr>
...
<table id="test1" style="border-style:solid;width:100%;" class="text-center">
    <thead>
        <tr>
            ...
            <th class="border" style='background-color:#FFCCFF;'>ETD/ETA</th>
    ...
    <tr style="text-align:right;">
        <td class="border" colspan="5" style="text-align:center;background-color:#FFCCFF;">TOTAL</td>
    ...
    <tr class="border" style="">
        ...
        <td style="text-align:center;font-weight:bold;" colspan="9"><label id="lblTotalText"></label></td>
        ...
        if (data.detail.length > 0) {
            ...
            for (let dr of data.detail[0]) {
             ...
             /*   html += '<td style="text-align:right">' + ShowNumber(dr.TotalNet, 2) + '</td>';*/
                ...
                html2 += '<td  class="vborder" style="text-align:center">' + ShowDate(dr.etdeta) + '</td>';
