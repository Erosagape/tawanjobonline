...
<table id="main" class="table" style="border-width:thin;border-collapse:collapse ;width:98%">
    <thead id="header">
        <tr class="upperLine underLine">
            ...
            <th class="center bold underLine" colspan="3" style="width:10%">AMOUNT IN THB</th>
        </tr>
        <tr class="upperLine">
            ...
            <th style="width: 10%; border: 1px black solid; border-collapse: collapse" class="center bold">TRANSPORT<br/>NON VAT</th>
    ...
    <tbody id="summary" style="border-top:1px black solid">
        <tr>
            ...
            <td style="text-align:right" id="sumSrvNonVat"></td>
	    <td style="text-align:right" id="sumSrvVat"></td>
        </tr>
    ...
    $.get(path + 'Acc/GetInvoice?Branch=' + branch + '&Code=' + code).done(function (r) {
        if (r.invoice.header.length > 0) {
	        ...
	        $.get(path + 'Master/GetCompany?Code='+h.BillToCustCode+'&Branch='+h.BillToCustBranch).done(function (r) {
                ...
                addr += '<br/>Tax ID : ' + b.TaxNumber + ' BRANCH : 0' +  (b.Branch=="0000"?"สำนักงานใหญ่":"0"+b.Branch);
		        $("#billAddress1").text(b.EAddress1);
		        $("#billAddress2").text(b.EAddress2);
                $("#billContactInfo").text('Tax ID : ' + b.TaxNumber + ' BRANCH : 0'+ (b.Branch=="0000"?"สำนักงานใหญ่":"0"+b.Branch));
	    ...
	    $("#remark3").text(h.Remark3);
	     ...
	     ShowCustomer(path, j.CustCode,j.CustBranch, '#cons');
            ...
            $("#sumSrvNonVat").text(ShowNumber(nonVat, 2));
            $("#sumSrvVat").text(ShowNumber(vat, 2));
