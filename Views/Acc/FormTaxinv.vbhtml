...
<table style="border-style:solid;width:100%;page-break-inside:auto" class="text-center">
    <tr style="background-color: #FFFFCC;">
        ...
        @*<th width="20">CUR</th>
            <th width="20">EXC</th>*@
        <th class="border" width="60">NO VAT</th>
        <th class="border" width="60">CHARGE</th>
    ...
    function ShowData(dt) {
        ...
        if (h.UsedLanguage == 'TH') {
            ...
            if (Number(h.BillToCustBranch) == 0) {
                ...
                branchText = ' สาขา 0000' + CCode(Number(h.BillToCustBranch));
            }
        } else {
        ...
        for (let d of dt) {
            ...
            html += '<td  class="vborder" style="text-align:right">' + (d.AmtAdvance + d.OASUM > 0 ? ShowNumber(d.AmtAdvance + d.OASUM, 2) : '0.00') + '</td>';
            html += '<td  class="vborder" style="text-align:right">' + (d.AmtCharge - d.OASUM > 0 ? ShowNumber(d.AmtCharge - d.OASUM,2):'') + '</td>';
            ...
            //if (d.AmtCharge > 0) {
            service += (Number(d.AmtCharge) - Number(d.OASUM) > 0 ? Number(d.AmtCharge) - Number(d.OASUM) : 0);
          ...
          //  amt += Number(d.Net)
            ...
            //} else {
            adv += (Number(d.AmtAdvance) + Number(d.OASUM) > 0 ? Number(d.AmtAdvance) + Number(d.OASUM) :0);
            //}
