...
<table id="main" class="table" style="border-width:thin;border-collapse:collapse ;width:98%" >
    <thead>
        <tr class="upperLine underLine">
            ...
            <th class="center bold underLine" rowspan="2">RATE</th>
 	    <th class="center bold underLine" rowspan="2">Curr.</th>
            <th class="center bold underLine" rowspan="2">QTYs</th>
            <th class="center bold underLine" rowspan="2">UOM</th>
            
            @*<th class="center bold underLine" rowspan="2">Exc.</th>*@
            @*<th class="center bold underLine" rowspan="2">@@ UNIT</th>*@
