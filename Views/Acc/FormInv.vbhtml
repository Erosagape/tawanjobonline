...
<div style="display:flex;width: 100%;" >
    ...
    <div id="master" class="bold" style="display: flex; flex-direction: column; justify-content: center; text-align: center; width: 100px; height: 60px; display: none">
        <h1 style="font-size:20px">ต้นฉบับ</h1>
...
<div style="display:flex;width: 100%;">
    ...
    <div style="width:30%">
        <h2 style="font-size:16px" class="center" id="headerDoc" ondblclick="AddHeaderNote()">ใบแจ้งหนี้/ใบวางบิล<br />INVOICE/BILLING NOTE </h2>
    </div>
...
<table class="table curveBorder" style="width:100%;border-width:thin;border-collapse:collapse;">
    <thead id="tbhead">
        ...
        <tr class="underLine greenbg" >
            ...
            <th style="width:80px;" class="center bold">NO VAT</th>
            <th style="width:80px;" class="center bold">CHARGE</th>
        </tr>
...
<div style="display:flex">
    <div style="flex:1;line-height:1.5">
        ...
        017-111-1943 &nbsp; KASIKORN BANK<br />
        218-301-7405 &nbsp; BANGKOK BANK<br /><br />
        ...
        บริษัทฯ ขอสงวนสิทธิ์ไม่รับเงินสดและเช็คในทุกกรณี &nbsp; <label style="font-size:0.8em;font-weight:bold">BANK TRANSFER ONLY. CASH AND CHEQUE NOT ACCEPTED.</label>
        <br />   <br />
    </div>
</div>
        ...
        if (r.invoice.header.length > 0) {
           ...
           /* }*/
            ...
            for (let row of d) {
                ...
                } else if (row.SICode.indexOf("OA") == 0) {
                    html += '        <td class="center">N</td>';
                } else {
                    html += '        <td class="center">' +row.Rate50Tavi+ '</td>';
                }
                ...
                html += '            <td class="right">' + (row.AmtAdvance || row.SICode.indexOf("OA")==0 ? ShowNumber(row.TotalAmt, 2) : '') + '</td>';
                html += '            <td class="right">' + (!row.AmtAdvance && row.SICode.indexOf("OA") != 0 ? ShowNumber(row.Amt, 2) : '') + '</td>';
                html += '        </tr>';
                if (row.AmtAdvance || row.SICode.indexOf("OA") == 0 ) {
                    adv += row.TotalAmt;
