    ...
    <table style="width:100%;" border="1" class="text-center">
        ...
        <tfoot>
            <tr style="font-weight:bold;">
                <td colspan="2" style="text-align:right;">BEFORE DISCOUNT</td>
                <td style="text-align: right;">
                    <label id="lblNoDiscountAdvance"></label>
                </td>
                <td style="text-align: right;">
                    <label id="lblNoDiscountSumNonVat"></label>
                </td>
                <td style="text-align: right;">
                    <label id="lblNoDiscountSumWht"></label>
                </td>
                <td style="text-align: right;">
                    <label id="lblNoDiscountSumBeforeVat"></label>
                </td>
            </tr>
            <tr style="font-weight:bold;">
    ...
    <div style="display:flex;margin-top:5px">
        <div id="box1" class="text-left" style="border:1px solid black;border-radius:5px;flex:1;margin-right:5px;padding:5px 5px 5px 5px;">
            ...
            <table style="width:100%">
                ...
                <tr>
                    <td style="width:45%">WHD TAX 5%</td>
                    <td style="width:35%;text-align:right">
                        (<label id="lblSumBaseWht5"></label>)
                    </td>
                    <td style="width:20%;text-align:right">
                        <label id="lblSumWht5"></label>
                    </td>
                </tr>
                <tr>
        ...
        if (d.length > 0) {
            for (let o of d) {
                ...
                if (o.AmtAdvance > 0) {
                    ...
                    html += '<td style="text-align:right;"></td>';
                    html += '<td style="text-align:right;">' + (o.AmtVat == 0 ? ShowNumber(o.AmtCharge + o.AmtDiscount, 2):'') + '</td>';
