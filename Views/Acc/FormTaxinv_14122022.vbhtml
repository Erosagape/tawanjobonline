...
<div style="display:flex;flex-direction:column">
    ...
    <div>
        ...
        NO <label id="lblChqNo">_______________</label> BANK <label id="lblChqBank">_________________</label>  AMOUNT <label id="lblChqAmount">______________</label>BAHT
    </div>
</div>
<br />
<div style="display:flex;">
...
<script type="text/javascript">
	...
	let vRemark = h.TRemark.split(';');
        ...
        $('#lblTotalNET').text(ShowNumber(amt-wht+adv , 2));
