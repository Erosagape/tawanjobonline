...
<div class="row">
    <div class="col-sm-6 @CustomerContainer"  style="display:flex">
        <div style="width:30%">
            <a href="../Master/Customers"><label style="display:block;width:100%;">Cust Code</label></a>
        </div>
...
<button type="button" class="btn btn-primary" onclick="handleClick();"><i class="glyphicon glyphicon-search"></i>Search Summary</button>
<button type="button" class="btn btn-warning" onclick="handleClick1();"><i class="glyphicon glyphicon-filter"></i>Search Details</button>
...
function handleClick() {
	     ...
	     if (!($("#txtDateFrom").val() && $("#txtDateTo").val())) {
            ...
            window.open(path +"Tracking/Dashboard?form=8_report" + params);
    ...
    function handleClick1() {
        ...
        window.open(path + "Tracking/Dashboard?form=8_reportByjob" + params);
