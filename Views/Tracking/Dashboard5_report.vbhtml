...
*/
        ...
        for (let o of lst) {
            ...
            html += '<td style="text-align:right">' + ShowNumber((o.SUMIM20==0? '' : o.SUMIM20),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMIM40 == 0 ? '' : o.SUMIM40),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMIMOTH == 0 ? '' : o.SUMIMOTH),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMEX20 == 0 ? '' : o.SUMEX20),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMEX40 == 0 ? '' : o.SUMEX40),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMEXOTH == 0 ? '' : o.SUMEXOTH),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMOT20 == 0 ? '' : o.SUMOT20),2) + '</td>';
            html += '<td style="text-align:right">' +  ShowNumber((o.SUMOT40 == 0 ? '' : o.SUMOT40),2) + '</td>';
            html += '<td style="text-align:right">' + ShowNumber((o.SUMOTOTH == 0 ? '' : o.SUMOTOTH),2) + '</td>';
            html += '</tr>';
        }
        html += '<tr>';
        html += '<td>TOTAL</td>';
        html += '<td  style="text-align:right">'+ countJob+'</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumIm20 == 0 ? '' : sumIm20),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumIm40 == 0 ? '' : sumIm40),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumImOt == 0 ? '' : sumImOt),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumEx20 == 0 ? '' : sumEx20),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumEx40 == 0 ? '' : sumEx40),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumExOt == 0 ? '' : sumExOt),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumOt20 == 0 ? '' : sumOt20),2) + '</td>';
        html += '<td  style="text-align:right">' + ShowNumber((sumOt40 == 0 ? '' : sumOt40),2) + '</td>';
        html += '<td style="text-align:right">' +  ShowNumber((sumOtOt == 0 ? '' : sumOtOt),2) + '</td>';
        html += '</tr>';
