...
<div style="display: flex;">
    ...
    <div style="flex:10%">
        <label style="color:blue;font-weight:bold" id="numberLbl">Number</label>
    </div>
    <div style="flex:20%">
        <label style="color:blue;font-weight:bold" id="number"></label>
    </div>
</div>
<div style="display: flex;">
        ...
        $.get(url, (r) => {
            if (r.data.length> 0) {
                ...
                for (let i = 0; i < dt1.length; i++) {
                    let tmp = html;
                    tmp = tmp.replaceAll('{0}', dt1[i].SICode === "AVF-000" ? "<div style='color:red'>" + dt1[i].SICode + " : " + dt1[i].SDescription + "</div>" :  dt1[i].SICode + " : " +dt1[i].SDescription);
            /*        tmp = tmp.replaceAll('{1}', dt1[i].LinkBillNo);*/
                    //tmp = tmp.replaceAll('{2}', dt1[i].CustCode);
                    tmp = tmp.replaceAll('{1}', dt1[i].PRVoucher ? dt1[i].PRVoucher : (dt1[i].InvRcv?dt1[i].InvRcv:""));
                    tmp = tmp.replaceAll('{1.5}', dt1[i].RVControl ? dt1[i].RVControl : "");
                    ...
                    console.log(dt1[i].BNet - dt1[i].ChargeVAT);
                    if (dt1[i].IsCredit == 1)
                    {
                        suma1 += dt1[i].BNet;
                    }
                ...
                for (let i = 0; i < dt2.length; i++) {
                    ...
                    let tmp = html;
                    tmp = tmp.replaceAll('{0}', dt2[i].SICode === "AVF-000" ? "<div style='color:red'>" + dt2[i].SICode + " : " + + dt2[i].SDescription + "</div>" : dt2[i].SICode + " : " +dt2[i].SDescription );
                 /*   tmp = tmp.replaceAll('{1}', dt2[i].LinkBillNo);*/
                    tmp = tmp.replaceAll('{1}', dt2[i].AdvPay ? dt2[i].AdvPay : (dt2[i].ClrPay?dt2[i].ClrPay:''));
                    tmp = tmp.replaceAll('{1.5}', dt2[i].RVControl ? dt2[i].RVControl : "");
