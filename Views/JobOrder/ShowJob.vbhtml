...
<br/>
                                    <label id="lblTRemark" for="txtPolicyCode">Bussiness Unit:</label>
                                    <input type="text" id="txtPolicyCode" style="width:300px" />
                                </div>
                                <div>
...
<script type="text/javascript">
    ...
    function ShowJob(Branch, Job) {
        ...
        .done(function (r) {
            if (r.job.data.length > 0) {
                ...
                $('#txtPolicyCode').val(dr.CPolicyCode);
    ...
    function OpenClearing() {
        window.open(path + 'Clr/Index?BranchCode=' + $('#txtBranchCode').val() + '&JNo=' + $('#txtJNo').val() + '&JobType=' + rec.JobType, '', '');
    }
    ...
    function GetDataSave(dr) {
        ...
        dr.CPolicyCode = $('#txtPolicyCode').val();
