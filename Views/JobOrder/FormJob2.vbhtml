...
<table class="table">
    <tbody>
        ...
        <tr>
            <td style="width:100px"><label>เลขที่ใบสั่งงาน</label></td>
            <td>:</td>
            <td style="width:100px"><label id="docNo"></label></td>
            <td style="width:100px"><label>Ref No.</label></td>
            <td>:</td>
            <td style="width:100px"><label id="refNo"></label></td>
            <td style="width:100px"><label>วันที่สั่งงาน</label></td>
            <td>:</td>
            <td style="width:100px"><label id="docDate"></label></td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="right"><label>72-1278 สป</label></td>
        </tr>
        <tr>
            <td colspan="4">
    ...
    function GetJob(Branch, Job) {
        ...
        .done(function (r) {
            if (r.job.data.length > 0) {
                ...
                $('#factory').text(r.CustCode);
                $('#docDate').text(CDateEN(rec.CreateDate));
                $('#product').text(rec.Description);
                $('#agent').text(rec.AgentCode);
                $('#vessel').text(rec.VesselName);
                $('#bookingNo').text(rec.BookingNo);
                $('#route').text(rec.DeliveryAddr);
                $('#remark').text(rec.TRemark);
