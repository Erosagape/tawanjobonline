    ...
    if (branch != "" && job != "") {
        ...
        $.get(url, (r) => {
            ...
            /*        tmp = tmp.replaceAll('{1}', dt1[i].LinkBillNo);*/
                    ...
                    tmp = tmp.replaceAll('{13}', dt1[i].ClrPay ? dt1[i].ClrPay : (dt1[i].ClrRcv ? dt1[i].ClrRcv:"" ));
                ...
                for (let i = 0; i < dt2.length; i++) {
                 ...
                 /*   tmp = tmp.replaceAll('{1}', dt2[i].LinkBillNo);*/
                    tmp = tmp.replaceAll('{1}', dt2[i].AdvPay ? dt2[i].AdvPay : "");
                    tmp = tmp.replaceAll('{1.5}', dt2[i].RVControl ? dt2[i].RVControl : "");
                    tmp = tmp.replaceAll('{13}', dt2[i].ClrPay ? dt2[i].ClrPay : (dt2[i].ClrRcv ? dt2[i].ClrRcv : ""));
