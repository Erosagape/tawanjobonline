...
<script type="text/javascript">
    ...
    function ReadData(dt) {
        ...
        for (const propname in incomegroup) {
            ...
            html += '<tr><td   style="border:1px black solid;font-weight:bold" colspan="13">' + propname + '</td></tr>';
            for (let r of rows) {
        ...
        sumCharge += '<td class="vborder" style="text-align:center" colspan="9">' + CNumThai(CDbl(totalCharge, 2)) + '</td>';
        sumCharge += '<td class="vborder" colspan="3" style="text-align:right">' + CCurrency(CDbl(totalCharge, 2)) + '</td>';
        sumCharge += '</tr>';
