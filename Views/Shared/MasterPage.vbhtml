        ...
        <div class="w3-sidebar w3-bar-block w3-indigo w3-card" style="width:250px;">
            ...
            <div id="dvCustomerMenu">
                ...
                <div id="mnuCust" class="w3-hide w3-pale-red w3-card-4">
                    <a href="#" id="mnuCust2" class="w3-bar-item w3-button" onclick="OpenMenu('SearchJob')">Shipment Order</a>
                ...
                <div id="mnuCustT" class="w3-hide w3-pale-red w3-card-4">
                    <a href="#" id="mnuCust1" class="w3-bar-item w3-button" onclick="OpenMenu('Tracking1')">Transport</a>
                    <a href="#" id="mnuCust3" class="w3-bar-item w3-button" onclick="OpenMenu('Tracking2')">Shipment</a>
                </div>
            ...
            <div id="dvShippingMenu">
                ...
                <div id="mnuRpt" class="w3-hide w3-amber w3-card-4">
                    ...
                    <a href="#" id="mnuRpt7" class="w3-bar-item w3-button" onclick="OpenMenu('Dashboard3')">Billing Dashboard</a>
                    <a href="#" id="mnuRpt8" class="w3-bar-item w3-button" onclick="OpenMenu('Dashboard4')">Volume Dashboard</a>
                    <a href="#" id="mnuRpt9" class="w3-bar-item w3-button" onclick="OpenMenu('Dashboard5')">Costing Dashboard</a>
