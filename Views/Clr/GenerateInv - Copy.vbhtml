                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <div style="display:flex;flex-direction:row">
                                            <input type="text" id="txtChqNo" class="form-control" />
        ...
        for (let obj of o) {
            if (obj.AmtCharge > 0 || obj.AmtAdvance > 0) {
                ...
                data.push({
                    ...
                    FTotalAmt: CDbl(obj.AmtNet / obj.ExchangeRate, 2),
                    AmtAdvance: (obj.AmtAdvance > 0 ? CDbl(obj.AmtAdvance  / obj.ExchangeRate,2) : 0),
                    AmtCharge: (obj.AmtCharge > 0 ? CDbl(obj.AmtCharge  / obj.ExchangeRate,2) : 0),
                    CurrencyCodeCredit: obj.CurrencyCode,
                    ExchangeRateCredit: obj.ExchangeRate,
                    AmtCredit: (creditamt >0 ? CDbl(creditamt,2) : 0),
                    FAmtCredit: (creditamt > 0 ? CDbl(creditamt / obj.ExchangeRate, 2) : 0),
