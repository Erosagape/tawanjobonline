        ...
        success: function(response) {
            ...
            if (res.result.length > 0) {
                            ...
                            if (c.indexOf('Date') >= 0) {
                                ...
                                if (r[c] !== null) {
                                    if (sumGroup[col].isSummary == true) {
                                        sumGroup[col].value += Number(r[c]);
                                        sumTotal[col] += Number(r[c]);
                                        html += '<td name="2" style="border:1px solid black;text-align:right;white-space: nowrap;padding-left:11px;">' + ShowNumber(r[c], 2) + '</td>';
                                    } else {
					                    if (r[c].length > 16) {
                                              html += '<td name="' + c + '" style="border:1px solid black;text-align:left;white-space: normal;min-width:60px">' + r[c] + '</td>';
                                        } else {
                                    ...
                                    html += '<td style="border:1px solid black;text-align:left;nowrap"></td>';
                                }
                            }
                            col++;
                        }
                ...
                if (groupCount > 0) {
                    ...
                    for (let i = 1; i < colCount; i++) {
                        if (sumGroup[i].isSummary == true) {
                            html += '<td style="background-color:lightblue;border:1px solid black;text-align:right;nowrap"><u><b>' + ShowNumber(sumGroup[i].value, 2) + '</b></u></td>';
                        } else {
                            html += '<td style="background-color:lightblue;border:1px solid black;text-align:right;nowrap"></td>';
                        }
                    }
                    html += '</tr>';
                    groupCount = 0;
