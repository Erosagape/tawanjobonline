...
function GetLanguage(msg) {
    if (mainLanguage == "TH") {
        let lang = {
            ...
            "Please enter config key": "กรุณาระบุรหัสแทนข้อมูล",
            "Please enter config value": "กรุณาระบุความหมายข้อมูล",
            ...
            "Please select some item first": "กรุณาระบุรายการที่ต้องการก่อน",
