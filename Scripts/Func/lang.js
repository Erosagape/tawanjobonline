    ...
    switch (fname) {
        ...
        case 'MODULE_ADV/Index':
            lang = {
                ...
                lblPaymentNo: 'Bill A/P|บิลค่าใช้จ่าย',
                lblJobType: 'Job Type|ประเภทงาน',
                lblShipBy: 'Ship By|ลักษณะงาน',
                ...
                lblDRemark: 'Remark/Invoice Vender|บันทึกเพิ่มเติม/ใบแจ้งหนี้Vender',
...
lblJNo:'BL No|BL No'
        ...
        case 'MODULE_ACC/Expense':
            lang = {
                ...
                lblSRemark: 'INVOICE/RECEIVE VENDER|ใบแจ้งหนี้/RECEIVE VENDER',
        ...
        case 'MODULE_ACC/RecvInv':
            lang = {
                ...
                lblTranDateCA: 'Trans.Date|วันที่ทำรายการ',
                lblTranTimeCA: 'Trans.Time|เวลาที่ทำรายการ',
                lblBankCA: 'From Bank|ธนาคาร',
                lblBranchCA: 'From Branch|สาขา',
                lblPayCA: 'Pay By|ชื่อบัญชี',
                ...
                lblBankCH: 'Issue Bank|ธนาคารที่ออกเช็ค',
                lblBranchCH: 'Issue Branch|สาขาที่ออกเช็ค',
                lblPayCH: 'Cheque Pay By|ชื่อผู้รับเงิน',
                ...
                lblBankCU: 'Issue Bank|ธนาคารที่ออกเช็ค',
                lblBranchCU: 'Issue Branch|สาขาที่ออกเช็ค',
                lblPayCU: 'Cheque Pay By|ชื่อผู้รับเงิน',
                linkCred: 'Credit|เครดิตบัญชี',
                lblRefNoCR: 'Ref No|เลขที่การลงบัญชี',
                lblTranDateCR: 'Ref Date|วันที่การลงบัญชี',
                lblPayCR: 'Pay By|ชื่อผู้รับบริการ',
                linkBal: 'Balance|ยอดคงเหลือ',
                lblForCA: 'For Cash/Transfer|สำหรับเงินสด/เงินโอน',
                lblForCH: 'For Cheque|สำหรับจ่ายเชิ็ค',
                lblBranch: 'Branch|สาขา',
        ...
        case 'MODULE_ACC/Voucher':
            lang = {
                ...
                lblRecDate: 'Date|วันที่',
                lblRecTime: 'Time|เวลา',
                lblPostBy: 'Approve By|ตรวจสอบโดย',
                lblPostDate: 'Date|วันที่',
                lblPostTime: 'Time|เวลา',
                ...
                lblRefBankName: 'Ref.Bank Name(ผู้รับ/จ่าย)|ชื่อธนาคาร ผู้รับ/จ่าย',
                ...
                lblPayTo: 'ชื่อผู้รับ/จ่ายเงิน|ชื่อผู้รับ/จ่ายเงิน',
                linkCurr: 'Currency|สกุลเงิน',
                lblCurrName: 'Currency Name|ชื่อสกุลเงิน',
        ...
        case 'MODULE_CS/ShowJob':
            lang = {
                ...
                lblInvFCountry: 'From Country|จากประเทศ',
                lblInvCountry: 'To Country(IMP) / From Country (EXP)|ไปประเทศ(IMP) / จากประเทศ (EXP)',
                lblInvInterPort: 'Port of Loading|ท่ารับบรรทุก',
                ...
                lblTransporter: 'Co-Loader|ตัวแทนโหลดหลัก',
                ...
                lblDutyDate: 'Inspection Date ETD/ETA(03)|วันที่ตรวจปล่อย (วันที่ยิงใบขน)',
                lblClearDate: 'Border Pass Date(04)|วันที่เคลียร์ของ (วันที่ส่งของ)',
                ...
                lblClearTaxReson: 'Paperless#|Paperless#',
        ...
        case 'MODULE_CS/Transport':
            lang = {
                ...
                lblSealNo: 'NEW B/L|เลข B/L ใหม่ ',
                lblSealNoXXX: 'Seal No.|เบอร์ซีล',
                ...
                lblComment: 'DN/CN NO. (AGENT)|DN/CN NO. (AGENT)',
                lblCommentXXX: 'Remarks for Delivery|บันทึกข้อความ',
                lblShippingMark: 'DN/CN NO.|DN/CN NO. ',
                lblShippingMarkXXX: 'Shipping Mark|ตราส่งหีบห่อ',
        ...
        case 'MODULE_MAS/Customers':
            lang = {
                ...
                lblDMailAddress: 'E-Mail (อีเมลลูกค้า)|อีเมล์',
                ...
                lblManagerCode: 'Sales|Sales',
                lblCSCodeIM: 'Contact|Contact',
                lblCSCodeEX: 'Account|Account',
                lblCSCodeOT: 'Finance|Finance',
        ...
        case 'MODULE_MAS/TransportRoute':
            lang = {
                ...
                lblPlace1: 'Receive|สถานที่รับสินค้า',
                lblAddress1: 'Address|ที่อยู่',
                lblContact1: 'Contact|ผู้ติดต่อ',
                lblPlace2: 'Loading|สถานที่ส่งสินค้า',
                lblAddress2: 'Address|ที่อยู่',
                lblContact2: 'Contact|ผู้ติดต่อ',
                lblPlace3: 'Delivery|สถานที่ปล่อยสินค้า',
                lblAddress3: 'Address|ที่อยู่',
                lblContact3: 'Contact|ผู้ติดต่อ',
...
function GetReportLists_V2() {
    return [
        ...
        { "ReportType": "ADD", "ReportGroup": "CLR", "ReportAuthor": "1,2,3,4,5,6,98,99", "ReportCode": "EARNEST", "ReportNameEN": "Earnest Summary", "ReportNameTH": "รายงานค่ามัดจำตู้" },
        { "ReportType": "ADD", "ReportGroup": "CLR", "ReportAuthor": "1,2,3,4,5,6,98,99", "ReportCode": "EARNEST2", "ReportNameEN": "Earnest Summary", "ReportNameTH": "รายงานเงินค้างรับคืนค่ามัดจำตู้" },
        ...
        { "ReportType": "EXP", "ReportGroup": "ACC", "ReportAuthor": "1,2,6,98,99", "ReportCode": "ARBAL", "ReportNameEN": "Accrue Income Report", "ReportNameTH": "รายงานลูกหนี้คงเหลือ" },
	    ...
	    {"ReportType":"ADD","ReportCode":"PROFITSALES","ReportGroup":"MKT","ReportNameTH":"รายงานกำไรของงานตามพนักงานขาย","ReportNameEN":"SalesProfitReport","ReportAuthor":"1,6,999","ReportUrl":""},
        ...
        {"ReportType":"ADD","ReportCode":"ARBAL4","ReportGroup":"ACC","ReportNameTH":"รายงานลูกหนี้ไม่ถึงดิวชำระ","ReportNameEN":"Accrue Income Report(Before Due)","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ARBAL5","ReportGroup":"ACC","ReportNameTH":"รายงานลูกหนี้ค้างชำระทั้งหมด","ReportNameEN":"Accrue Income Report(WAIT FOR PAY)","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ARBALALL","ReportGroup":"ACC","ReportNameTH":"รายงานรายรับ","ReportNameEN":"Accrue Income Report(ALL)","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"EARNEST2","ReportGroup":"CLR","ReportNameTH":"รายงานเงินค้างรับคืนค่ามัดจำตู้","ReportNameEN":"Earnest Summary","ReportAuthor":"1,2,3,4,5,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"INVDETAIL2","ReportGroup":"INV","ReportNameTH":"รายงานใบแจ้งหนี้ตามวันที่เอกสาร","ReportNameEN":"Invoice Expenses Detail","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"EXPDETAIL2","ReportGroup":"ADV","ReportNameTH":"รายงานบิลค่าใช้จ่ายแต่ละประเภท","ReportNameEN":"Bill-ExpenseDetail Report","ReportAuthor":"1,2,3,4,5,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ADVNOPV","ReportGroup":"ADV","ReportNameTH":"BFT รายงานใบเบิก ADVANCE AYMENT","ReportNameEN":"BFT รายงานใบเบิก ADVANCE PAYMENT","ReportAuthor":"1,2,3,4,5,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ARBALBANK","ReportGroup":"ACC","ReportNameTH":"BFT สมุดบัญชีรายงานรายรับ","ReportNameEN":"BFT สมุดบัญชีรายงานรายรับ","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"BFTCASHFLOW","ReportGroup":"ACC","ReportNameTH":"BFT รายรับรายวัน","ReportNameEN":"BFT รายงานรายรับรายวัน","ReportAuthor":"1,2,6,98,99","ReportUrl":""},{"ReportType":"EXP","ReportCode":"BFTJOBSTATUS","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS","ReportNameEN":"BFT JOB STATUS","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"EXP","ReportCode":"BFTJOBSTATUSACCOUNT","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS การเงิน บัญชี-ตั้งเบิก","ReportNameEN":"BFT JOB STATUS การเงิน บัญชี-ตั้งเบิก","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"EXP","ReportCode":"BFTJOBSTATUSCSEX","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS CS-EXPORT","ReportNameEN":"BFT JOB STATUS CS-EXPORT","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"EXP","ReportCode":"BFTJOBSTATUSCSIM","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS CS-IMPORT","ReportNameEN":"BFT JOB STATUS CS-IMPORT","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"EXP","ReportCode":"BFTJOBSTATUSFINANCEPAY","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS การเงิน job -จ่าย","ReportNameEN":"BFT JOB STATUS การเงิน job -จ่าย","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"EXP","ReportCode":"BFTJOBSTATUSFINANCEREC","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS การเงิน job -รับ","ReportNameEN":"BFT JOB STATUS การเงิน job -รับ","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"EXP","ReportCode":"BFTJOBSTATUSOPERATION","ReportGroup":"MKT","ReportNameTH":"BFT JOB STATUS OPERATION","ReportNameEN":"BFT JOB STATUS OPERATION","ReportAuthor":"1,2,3,6,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"BFTJOBSUM","ReportGroup":"EXE","ReportNameTH":"BFTJOBSUM","ReportNameEN":"BFTJOBSUM","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"BFTJOBSUMDETAIL","ReportGroup":"EXE","ReportNameTH":"BFTJOBSUMDETAIL","ReportNameEN":"BFTJOBSUMDETAIL","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"BFTSTATEMENT","ReportGroup":"FIN","ReportNameTH":"BFT กระทบยอดแบงค์","ReportNameEN":"BFT กระทบยอดแบงค์","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"CASHFLOWPAY","ReportGroup":"ADV","ReportNameTH":"BFT รายงานรายจ่ายรายวัน","ReportNameEN":"BFT รายงานรายจ่ายรายวัน","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"CLEARINJOB","ReportGroup":"ACC","ReportNameTH":"BFT CLEARING SUMMARY","ReportNameEN":"BFT CLEARING SUMMARY","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ESTIMATEGETSUM","ReportGroup":"ACC","ReportNameTH":"BFT รายงานประมาณการรายรับล่วงหน้า","ReportNameEN":"BFT รายงานประมาณการรายรับล่วงหน้า","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ESTIMATEPAYSUM","ReportGroup":"ADV","ReportNameTH":"BFT รายงานประมาณการรายจ่ายล่วงหน้า","ReportNameEN":"BFT รายงานประมาณการรายจ่ายล่วงหน้า","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ESTIMATEGET","ReportGroup":"ACC","ReportNameTH":"BFT รายงานประมาณการรายรับล่วงหน้า (Detail)","ReportNameEN":"BFT รายงานประมาณการรายรับล่วงหน้า (Detail)","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"ESTIMATEPAY","ReportGroup":"ADV","ReportNameTH":"BFT รายงานประมาณการรายจ่ายล่วงหน้า (Detail)","ReportNameEN":"BFT รายงานประมาณการรายจ่ายล่วงหน้า (Detail)","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"EXPDAILY2","ReportGroup":"ADV","ReportNameTH":"BFT สมุดบัญชีรายงานรายจ่าย","ReportNameEN":"BFT สมุดบัญชีรายงานรายจ่าย","ReportAuthor":"1,2,3,4,5,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"EXPNOPV","ReportGroup":"ADV","ReportNameTH":"BFT  รายงานค่าใช้จ่ายตั้งเบิก EXPENSE PAYMENT","ReportNameEN":"BFT รายงานค่าใช้จ่ายตั้งเบิก EXPENSE PAYMENT","ReportAuthor":"1,2,3,4,5,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"PAYDOC","ReportGroup":"ADV","ReportNameTH":"BFT รายงานประมาณการรายจ่ายล่วงหน้า ตามใบขออนุมัติเบิกจ่าย","ReportNameEN":"BFT รายงานประมาณการรายจ่ายล่วงหน้า ตามใบขออนุมัติเบิกจ่าย","ReportAuthor":"1,2,3,4,5,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"PROFITSALES","ReportGroup":"MKT","ReportNameTH":"BFT รายงานกำไรของงานตามพนักงานขาย","ReportNameEN":"BFT Sales Profit Report","ReportAuthor":"1,6,999","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"BFTSOA","ReportGroup":"ACC","ReportNameTH":"BFT SOA ยังไม่ได้จ่าย/รับ","ReportNameEN":"BFT SOA ยังไม่ได้จ่าย/รับ","ReportAuthor":"1,2,6,98,99","ReportUrl":""},
        {"ReportType":"ADD","ReportCode":"BFTSOAV","ReportGroup":"ACC","ReportNameTH":"BFT SOA จ่าย/รับแล้ว","ReportNameEN":"BFT SOA จ่าย/รับแล้ว","ReportAuthor":"1,2,6,98,99","ReportUrl":""}
    ];
}
