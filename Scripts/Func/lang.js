...
function GetLangMenu() {
    return {
        ...
        mnuAcc9: 'General Ledger|สรุปบัญชีแยกประเภท',
        mainRpt: 'Reports/Tracking|รายงานและการติดตามงาน',
        mnuRpt1: 'Reports|รายงานต่างๆ',
        mnuRpt2: 'Transport Tracking|การติดตามงานขนส่ง',
        mnuRpt3: 'Container Tracking|สรุปจำนวน container',
        mnuRpt4: 'Job Dashboard|ภาพรวมสถานะงาน',
        mnuRpt5: 'Document Tracking|การติดตามสถานะเอกสาร',
        mnuRpt6: 'Staff Dashboard|การติดตามสถานะ staff',
        mnuRpt7: 'Billing Dashboard|การติดตามสถานะ Billing',
        mnuRpt8: 'Volume Dashboard|สรุปจำนวน Job Status',
        mnuRpt9: 'Costing Dashboard|การติดตาม Costing',
        ...
        mnuVen2: 'Bill Payment|บันทึกบิลค่าใช้จ่าย',
        mnuVen1: 'Vender Summary|บันทึกสรุปวางบิล',
    ...
    switch (fname) {
        ...
        case 'MODULE_CS/ShowJob':
            lang = {
                ...
                lblConsignee: 'BILLING PLACE|สถานที่วางบิล',
                ...
                lblDescription: 'Consignee|Consignee',
                ...
                lblTotalCTN: 'Volume|ประเภทตู้',
                lblMeasurement: 'Meas.(M3)|ปริมาตร (M3)',
                lblDeliverNo: 'Delivery No|เลขที่ใบส่งของ',
                lblDeliverTo: 'Shipper|ผู้รับ/ส่งของ',
                lblProjectName: 'Description of Goods|ข้อมูลการบรรจุสินค้า',
                lblInvQty: 'Qty|จำนวนสินค้า',
                lblInvPackQty: 'Total Pallets|จำนวน Pallet',
        ...
        case 'MODULE_CS/Transport':
            lang = {
                ...
                lblFactoryDate: 'Delivery Date|วันที่ส่งของ',
...
function GetReportLists() {
	...
	{"ReportType":"EXC","ReportCode":"PROFITDETAIL","ReportGroup":"ACC","ReportNameTH":"รายงานรายละเอียดรายได้ค่าใช้จ่ายตามจ๊อบงาน","ReportNameEN":"Income and Expenses Details Report By Job","ReportAuthor":"1,2,3,4,5,6,7,98,99"}   ,
	{"ReportType":"ADD","ReportCode":"JOBPROFIT","ReportGroup":"ACC","ReportNameTH":"รายงานกำไรขั้นต้นตามจ๊อบ","ReportNameEN":"Job Costing And Profit","ReportAuthor":"1,2,6,98,99"},
	{"ReportType":"ADD","ReportCode":"GROSSPROFIT","ReportGroup":"ACC","ReportNameTH":"รายงานสรุปกำไรขั้นต้นตามประเภทงาน","ReportNameEN":"Gross Profit Report","ReportAuthor":"1,2,6,98,99"},
	{"ReportType":"ADD","ReportCode":"CUSTPROFIT","ReportGroup":"ACC","ReportNameTH":"รายงานสรุปกำไรขั้นต้นตามลูกค้า","ReportNameEN":"Customer Profit Report","ReportAuthor":"1,2,6,98,99"}
...
function GetReportLists_V2() {
	...
	{"ReportType":"ADD","ReportCode":"ARAGINGSUM","ReportGroup":"ACC","ReportNameTH":"รายงานสรุปใบแจ้งหนี้ค้างชำระตามลูกค้า","ReportNameEN":"AR Outstanding Report Summary","ReportAuthor":"1,2,6,98,99"}
    ];
}
